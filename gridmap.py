...
class GridCam( object ):
    ...
    def __init__( self, gmap, pos, facing, plane ):
...
class GridRay( object ):
    ...
    def cast( self, x, pos, screen_sz ):
        ...
        if 100 == x:
            print "sdx: " + str( self.side_dist_x ) + " sdy: " + str( self.side_dist_x )
